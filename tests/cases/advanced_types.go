...
func (_ testTask) ProcessCustomTypes(
	ci CustomInt,
	cs CustomString,
	csl CustomSlice,
...
func (_ testTask) ProcessTimeAndDuration(
	t time.Time,
	d time.Duration,
...
func (_ testTask) ProcessNestedStructs(outer OuterStruct) OuterStruct {
	outer.ID *= 2
...
func (_ testTask) ProcessNestedCollections(
...
func (_ testTask) ProcessVariadic(base int, values ...int) []int {
...
func (_ testTask) MultipleReturnTypes() (int, string, []int, map[string]int, bool, error) {
...
func (_ testTask) TaskWithSliceOfInterface(data []interface{}) []interface{} {
	return data
}

// Test map with interface{} values
func (_ testTask) TaskWithMapOfInterface(data map[string]interface{}) map[string]interface{} {
	return data
}
...
func (_ testTask) TaskWithDeeplyNestedInterface(s DeeplyNestedStruct) DeeplyNestedStruct {
	return s
}
...
func (_ testTask) ProcessLargeStruct(large LargeStruct) LargeStruct {
